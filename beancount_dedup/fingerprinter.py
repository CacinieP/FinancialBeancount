...
class TransactionFingerprinter:
    ...
    def check_l2_match(self, tx1: Transaction, tx2: Transaction, 
                       fp1: Dict, fp2: Dict) -> bool:
        """
        L2匹配的二次验证
        ...
        if l3_1["is_expense"] != l3_2["is_expense"]:
            return False
        
        return True
    
    def check_l3_match(self, tx1: Transaction, tx2: Transaction,
                       fp1: Dict, fp2: Dict) -> Optional[Dict]:
        """
        L3模糊匹配检测
